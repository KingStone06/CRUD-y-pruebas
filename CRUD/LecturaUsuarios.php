...
class LecturaUsuariosTest extends TestCase
{
    ...
    public function testLeerUsuariosExitoso()
    {
        ...
        $datosPrueba = [
            (object)['id' => 1, 'nombre' => 'Juan', 'correo' => 'juan@example.com'],
            (object)['id' => 2, 'nombre' => 'Maria', 'correo' => 'maria@example.com'],
        ];

        // Creamos un mock de PDOStatement
        $stmt = $this->createMock(PDOStatement::class);
        $stmt->method('fetch')
             ->willReturnOnConsecutiveCalls($datosPrueba[0], $datosPrueba[1], false); // Dos usuarios y luego false para indicar el fin de los resultados
